...
public class Manager {
    ...
    public static void initialiseProcess(String functionName, String parameter) throws IOException {
        ProcessBuilder processBuilder = new ProcessBuilder(
                "java", "-cp", ";F:\\Learning\\3d-Course\\OS\\lab1.2\\lib\\lab1.jar", "clients.Function" + functionName);
        processBuilder.directory(new File("F:\\Learning\\3d-Course\\OS\\lab1.2\\target\\classes"));
